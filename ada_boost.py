...
for i in [1,2,3]:
    for criteria in ['gini', 'entropy', 'log_loss']:
        base_models.append(DecisionTreeClassifier(max_depth=i, criterion=criteria, random_state=1))
        base_models.append(DecisionTreeClassifier(max_depth=i, criterion=criteria, class_weight='balanced', random_state=1))
...
for i in [1,2,3]:
    for criteria in ['gini', 'entropy', 'log_loss']:
        base_models_os.append(DecisionTreeClassifier(max_depth=i, criterion=criteria, random_state=1))
